...
function html5blank_styles()
{
    ...
    wp_register_style('bootstrap', get_template_directory_uri() . '/css/bootstrap/css/bootstrap.css', array(), '1.0', 'all');
...
add_action('init', 'register_theme_menus'); // Add HTML5 Blank Menu
